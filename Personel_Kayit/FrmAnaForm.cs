...
namespace Personel_Kayit
{
    public partial class FrmAnaForm : Form
    {
        ...
        {
            int dgr = dataGridView1.SelectedCells[0].RowIndex;

            Txtid.Text = dataGridView1.Rows[dgr].Cells[0].Value.ToString();
            TxtAd.Text = dataGridView1.Rows[dgr].Cells[1].Value.ToString();
            TxtSoyad.Text = dataGridView1.Rows[dgr].Cells[2].Value.ToString();
            CmbSehir.Text = dataGridView1.Rows[dgr].Cells[3].Value.ToString();
            MskMaas.Text = dataGridView1.Rows[dgr].Cells[4].Value.ToString();
            label8.Text = dataGridView1.Rows[dgr].Cells[5].Value.ToString();
            TxtMeslek.Text = dataGridView1.Rows[dgr].Cells[6].Value.ToString();
        }
